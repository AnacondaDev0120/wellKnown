...
async function troll2Transform(audioBuffer) {
  ...
  oscillator1.frequency.value = 0;//-10
  oscillator1.type = 'sawtooth';

  let oscillator2 = ctx.createOscillator();
  oscillator2.frequency.value = 40;//50
  oscillator2.type = 'sawtooth';

  let oscillator3 = ctx.createOscillator();
  oscillator3.frequency.value = 10;//30
  oscillator3.type = 'sawtooth';
  // ---
  let oscillatorGain = ctx.createGain();
  oscillatorGain.gain.value = 0.002;//0.007
  // ---
  let oscillatorGain2 = ctx.createGain();
  oscillatorGain2.gain.value = 0.002;//0.007
  // ---
  ...
  filter.type = "lowpass";
  filter.frequency.value = 1000;//2000
